export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	abomasnow: {
		...
		evoLevel: 40,
		eggGroups: ["Monster", "Grass"],
		otherFormes: ["Abomasnow-Sylvania", "Abomasnow-Mega"],
		formeOrder: ["Abomasnow", "Abomasnow-Sylvania", "Abomasnow-Mega"],
	},
	abomasnowsylvania: { //Sylvania
		num: 460,
		name: "Abomasnow-Sylvania",
		types: ["Rock", "Ice"],
		baseStats: {hp: 60, atk: 104, def: 60, spa: 104, spd: 70, spe: 96},
		abilities: {0: "Snow Warning", H: "Packed Ice"},
		heightm: 2.2,
		weightkg: 135.5,
		color: "White",
		prevo: "Snover",
	...
	chunkababy: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 105, atk: 75, def: 110, spa: 80, spd: 110, spe: 50},
	...
	chunkanaden: {
		num: -6003,
		name: "Chunkanaden", //This is the English word "chuck" combined with part of the North American Beaver's scientific name, C. canadensis
		types: ["Grass", "Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 105, atk: 75, def: 110, spa: 80, spd: 110, spe: 50},
		abilities: {0: "Overgrow", H: "Fluffy"},
		heightm: 1.5,
		weightkg: 61,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	stoomulosus: {
		num: -6006,
		name: "Stoomulosus", //This is the Dutch term for steam "stoom-" and part of the Common Mudpuppy's scientific name, N. maculosus
		types: ["Water", "Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 80, def: 90, spa: 130, spd: 90, spe: 80},
		abilities: {0: "Torrent", H: "Steam Rocket"},
		heightm: 1.5,
		weightkg: 61,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	werabuey: {
		num: -6009,
		name: "Werabuey", //This means "hot ox", 'wera' being 'hot' in Maori and 'buey' being 'bull' in Spanish
		types: ["Fire", "Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 110, atk: 120, def: 65, spa: 60, spd: 70, spe: 105},
		abilities: {0: "Blaze", H: "Charred"},
		heightm: 1.5,
		weightkg: 61,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	glowwor: {
		...
		baseStats: {hp: 40, atk: 35, def: 25, spa: 30, spd: 20, spe: 40},
		abilities: {0: "Shield Dust", H: "Run Away"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		evos: ["Torpod"],
	...
	torpod: {
		...
		types: ["Bug"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 45, atk: 20, def: 60, spa: 30, spd: 60, spe: 20},
		abilities: {0: "Run Away", H: "Shell Armor"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		prevo: "Glowwor",
		evos: ["Lympyre"],
	...
	lympyre: {
		...
		types: ["Bug", "Dragon"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 50, atk: 60, def: 80, spa: 110, spd: 70, spe: 90},
		abilities: {0: "Tinted Lens", H: "Illuminate"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		prevo: "Torpod",
	},
	ameribear: {
		...
		types: ["Ice", "Water"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 100, atk: 140, def: 80, spa: 70, spd: 80, spe: 61},
		abilities: {0: "Thick Fat", 1: "Swift Swim", H: "Cloud Nine"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
	},
	womper: {
		...
		types: ["Fairy", "Ground"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 61, atk: 100, def: 112, spa: 105, spd: 112, spe: 80},
		abilities: {0: "Effect Spore", 1: "Oblivious"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
	},
	moscamir: {
		num: -6015,
		name: "Moscamir", //"Mosca" from mosquito, "-amir" from Vladamir
		types: ["Bug", "Dark"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 35, atk: 50, def: 40, spa: 40, spd: 40, spe: 61},
		abilities: {0: "Vampyrism"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		evos: ["Culicacard"],
	},
	culicacard: {
		num: -6016,
		name: "Culicacard", //"Culic" from culicidae, "-ard" from Alucard
		types: ["Bug", "Dark"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 60, atk: 110, def: 90, spa: 65, spd: 90, spe: 97},
		abilities: {0: "Vampyrism", 1: "Illuminate"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		prevo: "Moscamir",
	},
	porygon9x: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 120, atk: 80, def: 105, spa: 105, spd: 110, spe: 60},
		abilities: {0: "Filter", 1: "Download", H: "Analytic"},
		prevo: "Porygon2",
		eggGroups: ["Undiscovered"],
		weightkg: 1,
	},
	"porygon3.0": {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 70, atk: 110, def: 60, spa: 115, spd: 70, spe: 110},
		abilities: {0: "Scrappy", 1: "Download", H: "Analytic"},
		prevo: "Porygon2",
		eggGroups: ["Undiscovered"],
		weightkg: 1,
	},
	partree: {
		num: -6019,
		name: "Partree", //"Part tree" I am so good at this
		types: ["Rock", "Grass"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 80, atk: 112, def: 149, spa: 30, spd: 81, spe: 40},
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Rattled"},
		prevo: "Sudowoodo",
		eggGroups: ["Undiscovered"],
		weightkg: 1,
	...
	sewsloge: {
		num: -6020,
		name: "Sewsloge", //"Sewage" + "Slop"
		types: ["Poison", "Water"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 146, atk: 98, def: 112, spa: 71, spd: 102, spe: 60},
		abilities: {0: "Stench", 1: "Weak Armor", H: "Aftermath"},
		prevo: "Garbodor",
		eggGroups: ["Undiscovered"],
		weightkg: 1,
	...
	bibibin: {
		num: -6022,
		name: "Bibibin", //Cute gibberish you might say at a rabbit. Also "bun bun" => "bin bin" etc.
		types: ["Fairy"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 50, atk: 50, def: 50, spa: 50, spd: 50, spe: 50},
		abilities: {0: "Fairy Aura"},
	...
	nubunubu: {
		num: -6023,
		name: "Nubunubu", //Cute gibberish you might say at a rabbit. Also "nibble" => "nub". You get it.
		types: ["Fairy"],
		genderRatio: {M: 0.5, F: 0.5},
		...
		weightkg: 1,
		prevo: "Bibibin",
		evos: ["Brrybry", "Kikkiki"],
	},
	brrybry: {
		num: -6024,
		name: "Brrybry", //Cute gibberish you might say at a rabbit, but "brr" and "y" because "brr cold baby."
		types: ["Fairy", "Ice"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 80, atk: 100, def: 70, spa: 120, spd: 70, spe: 160},
		abilities: {0: "Fairy Aura"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		prevo: "Nubunubu",
	...
	kikkiki: {
		num: -6025,
		name: "Kikkiki", //Cute gibberish you might say at a rabbit.
		types: ["Fairy", "Normal"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 160, atk: 104, def: 102, spa: 92, spd: 102, spe: 40},
		abilities: {0: "Fairy Aura"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		prevo: "Nubunubu",
	...
	saugdrache: {
		num: -6026,
		name: "Saugdrache", //Small dragon or smth in German
		types: ["Dragon"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 50, atk: 50, def: 50, spa: 50, spd: 50, spe: 50},
		abilities: {0: "Dragon's Maw"},
	...
	jundrache: {
		num: -6027,
		name: "Jundrache", //Juvenille dragon or smth in German
		types: ["Dragon"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 75, atk: 75, def: 75, spa: 75, spd: 75, spe: 75},
		abilities: {0: "Dragon's Maw"},
		...
		weightkg: 1,
		prevo: "Saugdrache",
		evos: ["Erddrache", "Geisterdrache"],
	},
	erddrache: {
		num: -6028,
		name: "Erddrache", //Ground dragon in German
		types: ["Dragon", "Ground"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 78, atk: 88, def: 112, spa: 130, spd: 90, spe: 102},
		abilities: {0: "Dragon's Maw"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		prevo: "Jundrache",
	...
	geisterdrache: {
		num: -6029,
		name: "Geisterdrache", //Ghost dragon in German
		types: ["Dragon", "Ghost"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 102, atk: 115, def: 91, spa: 110, spd: 98, spe: 84},
		abilities: {0: "Dragon's Maw"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		prevo: "Jundrache",
	...
	grooslin: {
		num: -6030,
		name: "Grooslin", //"Grouseling" => "Grooslin"
		types: ["Ground"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 44, atk: 44, def: 44, spa: 44, spd: 44, spe: 44},
		abilities: {0: "Gluttony", 1: "Tangled Feet", H: "Thick Fat"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		evos: ["Grooslata"],
	},
	grooslata: {
		num: -6031,
		name: "Grooslata", //"Grouse" and random sound
		types: ["Ground", "Flying"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 60, atk: 60, def: 60, spa: 60, spd: 60, spe: 60},
		abilities: {0: "Gluttony", 1: "Tangled Feet", H: "Thick Fat"},
	...
	combocombine: {
		...
		types: ["Steel", "Fire"],
		gender: "N",
		baseStats: {hp: 117, atk: 117, def: 117, spa: 117, spd: 117, spe: 117},
		abilities: {0: "Levitate"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		otherFormes: ["ComboCombineAlt1", "ComboCombineAlt2"],
		formeOrder: ["ComboCombine", "ComboCombineAlt1", "ComboCombineAlt2"],
		changesFrom: "Combo A",
	},
	combocombinealt1: {
		num: -6036,
		name: "ComboCombineAlt1",
		types: ["Fire", "Electric"],
		gender: "N",
		baseStats: {hp: 117, atk: 117, def: 117, spa: 117, spd: 117, spe: 117},
		abilities: {0: "Levitate"},
	...
	chucklet: {
		num: -6039,
		name: "Chucklet", //"Woodchuck" + "-let" indicating small
		types: ["Ground"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 42, atk: 42, def: 42, spa: 42, spd: 42, spe: 42},
		abilities: {0: "Run Away", 1: "Hustle", H: "Arena Trap"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		evos: ["Chuckog"],
	},
	...
	blucifer: {
		num: -6041,
		name: "Blucifer", //Blue + Lucifer, obv
		types: ["Fairy", "Fighting"],
		gender: "M",
		baseStats: {hp: 78, atk: 96, def: 66, spa: 60, spd: 81, spe: 109},
		abilities: {0: "Rattled", 1: "Anticipation", H: "Tough Claws"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
	},
	ledelin: {
		...
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 75, atk: 75, def: 75, spa: 75, spd: 75, spe: 75},
		abilities: {0: "Levitate", 1: "Flash Fire", H: "Boil Over"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		evos: ["Cauldrot"],
	},
	cauldrot: {
		...
		types: ["Ghost", "Steel"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 110, atk: 68, def: 102, spa: 88, spd: 112, spe: 82},
		abilities: {0: "Levitate", 1: "Flash Fire", H: "Boil Over"},
		eggGroups: ["Undiscovered"],
		weightkg: 1,
		prevo: "Ledelin",
